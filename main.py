...
os.chdir('/home/kip/Desktop/t/xkcd-notifier')
...
try:
	...
	while True:
		...
		if useFile('latest', 'r', '')[4:] == 'Internet':
			sendMail('kieran.houtgraaf@gmail.com', 'Internet Error', 'On one ore more runs there was no internet connection, causing it to error. Check the logs for more details.')
